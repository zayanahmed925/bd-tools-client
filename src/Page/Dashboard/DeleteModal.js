            ...
            <div className="modal modal-bottom sm:modal-middle ">
                <div className="modal-box">
                    <div className="text-center p-5 flex-auto justify-center">
                        ...
                        <p className="text-sm text-gray-500 px-8">Do you really want to delete <span className='text-orange-500'>{name}</span>?
                            This process cannot be undo!!</p>
                    </div>
                    <div className="modal-action">

                        <button onClick={() => handleDelete(_id)} className="btn btn-sm btn-error">Delete</button>
                        <label for="delete-modal" className="btn btn-sm btn-success">Cancel</label>
                    </div>
                </div>
            </div>
